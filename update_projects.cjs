...
const newFeaturedProjectsStr = `featuredProjects: [
        {
          ...
          title: t.jobTitle1,
          date: t.jobDate1,
          company: lang === 'en' ? 'Georgian National Spatial Data Infrastructure' : 'საქართველოს ეროვნული სივრცითი მონაცემების ინფრასტრუქტურა',
          companyLink: "https://nsdi.gov.ge/",
          desc: [t.jobDesc1[0]],
          status: lang === 'en' ? 'Completed' : 'დასრულებული',
        },
        {
          id: 'proj2',
          title: t.jobTitle1,
          date: t.jobDate1,
          company: lang === 'en' ? 'National Agency of Public Registry of Georgia' : 'საჯარო რეესტრის ეროვნული სააგენტო',
          companyLink: "https://napr.gov.ge/",
          desc: [t.jobDesc1[1]],
          status: lang === 'en' ? 'In Development' : 'დეველოპმენტის პროცესში',
        },
        {
          id: 'proj3',
        ...
        },
        {
          ...
          desc: t.projectDesc2,
          status: lang === 'en' ? 'Optimizing' : 'მიმდინარეობს გაუმჯობესება',
        }
      ],
      skills: [`;
